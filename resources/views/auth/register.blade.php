            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="date_birthday" class="col-md-4 col-form-label text-md-right">{{ __('Date_birthday') }}</label>

                            <div class="col-md-6">
                                <input id="date_birthday" type="date" class="form-control @error('date_birthday') is-invalid @enderror" name="date_birthday" value="{{ old('date_birthday') }}" required autocomplete="date_birthday">
